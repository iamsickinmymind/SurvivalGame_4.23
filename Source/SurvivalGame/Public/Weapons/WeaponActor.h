...
// This weapon class is based on Epic Games shooter game Weapon class
...
UCLASS()
class SURVIVALGAME_API AWeaponActor : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** This socket is actve in First person mode.*/
	UPROPERTY(EditDefaultsOnly, Category = Effects)
	FName AttachSocket1P;

	/**Name of the socket to attach to the character on*/
	/** This socket is active in Third person mode.*/
	UPROPERTY(EditDefaultsOnly, Category = Effects)
